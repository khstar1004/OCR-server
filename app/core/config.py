...
class Settings(BaseSettings):
    ...
    ocr_retry_low_quality: bool = Field(default=False, alias="OCR_RETRY_LOW_QUALITY")
    ...
    playground_default_max_pages: int = Field(default=0, alias="PLAYGROUND_DEFAULT_MAX_PAGES")
